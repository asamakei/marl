...
class Viewer(object):
    ...
    def draw_image(self, fname, width, height, **attrs):
        geom = make_image(fname=fname, width=width, height=height)
        _add_attrs(geom, attrs)
        self.add_onetime(geom)
        return geom
...
def make_image(fname='/home/mrm/Pictures/lion.png', width=0.2, height=0.2):
    return Image(fname, width, height)
