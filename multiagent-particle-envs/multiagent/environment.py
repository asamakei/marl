...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
        ...
        for agent in self.agents:
            ...
            #print (agent.name, "observation space: ", obs_dim, ", action spase: ", [act for act in total_action_space])
        ...
        if True: #self.render_geoms is None:
            ...
            for entity in self.world.entities:
                ...
                if 'agent' in entity.name:
                    ...
                    geom2.set_color(*entity.color, alpha=0.2)
                ...
                if entity.good and hasattr(entity, 'target_pos'):
                    ...
                    geom4 = rendering.make_circle(0.01, filled=True)
                    geom4.set_color(*np.array([0,1,0]), alpha=0.8)
